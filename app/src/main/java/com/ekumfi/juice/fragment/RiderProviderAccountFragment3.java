...
public class RiderProviderAccountFragment3 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        identification_image.setOnClickListener(view -> {
            if (identification_image.getDrawable() == null) {
                ...
                PictureActivity.idPicBitmap = ((RoundedDrawable) identification_image.getDrawable()).getSourceBitmap();
    ...
    public void init() {
        if (RiderProviderAccountActivity.realmProvider != null) {
            String picture = RiderProviderAccountActivity.realmProvider.getIdentification_image_url();
            boolean pictureExists = picture != null;
            if (pictureExists) {
                Glide.with(getContext())
                        .load(RiderProviderAccountActivity.realmProvider.getIdentification_image_url())
            ...
            identification_type_spinner.setSelection(((ArrayAdapter) identification_type_spinner.getAdapter()).getPosition(RiderProviderAccountActivity.realmProvider.getIdentification_type()));
            identification_number.setText(RiderProviderAccountActivity.realmProvider.getIdentification_number());
        }
    }
    ...
    public boolean validate() {
        ...
        if (identification_image.getDrawable() == null && SellerAccountActivity.realmSeller.getIdentification_image_url() == null) {
