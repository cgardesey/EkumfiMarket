...
public class RiderProviderAccountFragment5 extends MultiPickerWrapperSupportFragment {
    ...
    public static File license_image_file = null;
    MultiPickerWrapper.PickerUtilListener multiPickerWrapperListener = new MultiPickerWrapper.PickerUtilListener() {
        ...
        public void onImagesChosen(List<ChosenImage> list) {
            ...
            license_image_file = new File(list.get(0).getOriginalPath());
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.fragment_rider_provider_account5, container, false);
        drivers_licence_image = rootView.findViewById(R.id.drivers_licence_image);
    ...
    public void init() {
        if (RiderProviderAccountActivity.realmProvider != null) {
            String picture = RiderProviderAccountActivity.realmProvider.getDrivers_licence_image_url();
