...
public class RiderProviderAccountFragment1 extends MultiPickerWrapperSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.fragment_rider_provider_account1, container, false);
        ...
        profilePic.setOnClickListener(view -> {
            if (profilePic.getDrawable() == null) {
                ...
                PictureActivity.idPicBitmap = ((RoundedDrawable) profilePic.getDrawable()).getSourceBitmap();
    ...
    public void init() {
        ...
        if (RiderProviderAccountActivity.realmProvider != null) {
            String picture = RiderProviderAccountActivity.realmProvider.getProfile_image_url();
            boolean pictureExists = picture != null;
            if (pictureExists) {
                Glide.with(getContext())
                        .load(RiderProviderAccountActivity.realmProvider.getProfile_image_url())
            ...
            title.setSelection(((ArrayAdapter) title.getAdapter()).getPosition(RiderProviderAccountActivity.realmProvider.getTitle()));
            firstName.setText(RiderProviderAccountActivity.realmProvider.getFirst_name());
            lastName.setText(RiderProviderAccountActivity.realmProvider.getLast_name());
            otherNames.setText(RiderProviderAccountActivity.realmProvider.getOther_name());
            gender.setSelection(((ArrayAdapter) gender.getAdapter()).getPosition(RiderProviderAccountActivity.realmProvider.getGender()));
        }
    }
