...
public class AndExoPlayerView extends LinearLayout implements View.OnClickListener {
    ...
    public boolean currPlayWhenReady = false;
...
//                    Toast.makeText(context, "State idle", Toast.LENGTH_SHORT).show();
                    break;
                case Player.STATE_BUFFERING:
                    stateString = "ExoPlayer.STATE_BUFFERING -";
//                    Toast.makeText(context, "State buffering", Toast.LENGTH_SHORT).show();
                    break;
                case Player.STATE_READY:
//                    Toast.makeText(context, "State ready", Toast.LENGTH_SHORT).show();
                    if (isPreparing) {
                        // this is accurate
                        isPreparing = false;
...
//            Toast.makeText(context, "Seek processed", Toast.LENGTH_SHORT).show();
        }
...
//            Toast.makeText(context, "Play when ready", Toast.LENGTH_SHORT).show();
        }
    }
